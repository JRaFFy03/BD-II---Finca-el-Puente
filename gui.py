...
class AppGanado(ctk.CTk):
    def __init__(self):
        ...
        # IMPORTANTE: EL QR DEBE APUNTAR A ficha.html
        # =============================================================
...
<body>
    <div class="documento">
        ...
        <div class="chart-container">
            ...
            <div class="bar-group">
                <div class="bar-label">⚖️ Peso promedio: {a_peso:.2f} Kg</div>
    ...
    def procesar_ia_ganadera(self, consulta):
        ...
        try:
            ...
            if any(x in consulta_min for x in ["hola", "buenas", "saludo", "hey", "asistente"]):
                self.agregar_burbuja_texto(
                    "¡Hola! Estoy listo para ayudarte con consultas de la finca 🐄",
                    es_asistente=True
                )
                return
